...
class OperatorPulangCepatController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('operator.kehadiran.pulang-cepat.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('operator.kehadiran.pulang-cepat.export-pdf', ['pulangs' => $pulangs])->setPaper('A4', 'potrait');
