...
class OperatorCutiMenikahController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('operator.kehadiran.cuti-menikah.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('operator.kehadiran.cuti-menikah.export-pdf', ['cutis' => $cutis])->setPaper('A4', 'potrait');
