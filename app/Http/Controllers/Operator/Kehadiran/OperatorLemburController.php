...
class OperatorLemburController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('operator.kehadiran.lembur.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('operator.kehadiran.lembur.export-pdf', ['lemburs' => $lemburs])->setPaper('A4', 'potrait');
