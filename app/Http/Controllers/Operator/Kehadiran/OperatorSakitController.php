...
class OperatorSakitController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('operator.kehadiran.sakit.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('operator.kehadiran.sakit.export-pdf', ['sakits' => $sakits])->setPaper('A4', 'potrait');
