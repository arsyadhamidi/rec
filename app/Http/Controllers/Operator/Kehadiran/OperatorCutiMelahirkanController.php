...
class OperatorCutiMelahirkanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('operator.kehadiran.cuti-melahirkan.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('operator.kehadiran.cuti-melahirkan.export-pdf', ['cutis' => $cutis])->setPaper('A4', 'potrait');
