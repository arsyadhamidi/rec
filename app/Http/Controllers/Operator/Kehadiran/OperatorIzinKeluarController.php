...
class OperatorIzinKeluarController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('operator.kehadiran.izin-keluar.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('operator.kehadiran.izin-keluar.export-pdf', ['izins' => $izins])->setPaper('A4', 'potrait');
