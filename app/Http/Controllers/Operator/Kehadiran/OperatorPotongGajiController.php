...
class OperatorPotongGajiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('operator.kehadiran.potong-gaji.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('operator.kehadiran.potong-gaji.export-pdf', ['cutis' => $cutis])->setPaper('A4', 'potrait');
