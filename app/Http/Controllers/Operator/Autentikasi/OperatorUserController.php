...
class OperatorUserController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $dataWithActions = $data->map(function ($item) {
                $resultid = $item->id ?? '';
                $editUrl = route('operator-users.edit', $item->id ?? '');
    ...
    ';
        ...
        return view('operator.autentikasi.users.index', [
            'levels' => $levels,
            'jabatans' => $jabatans,
        ]);
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('operator.autentikasi.users.export-pdf', ['users' => $users])->setPaper('A4', 'potrait');
    ...
    public function create()
    {
        ...
        return view('operator.autentikasi.users.create', [
            'levels' => $levels,
            'jabatans' => $jabatans,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator-users.index')->with('success', 'Anda berhasil membuat data user registrasi baru!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('operator.autentikasi.users.edit', [
            'levels' => $levels,
            'jabatans' => $jabatans,
            'users' => $users,
        ]);
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('operator-users.index')->with('success', 'Anda berhasil memperbaharui data user registrasi baru!');
    }
