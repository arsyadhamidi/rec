...
class OperatorLevelController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $dataWithActions = $data->map(function ($item) {
                $resultid = $item->id ?? '';
                $editUrl = route('operator-level.edit', $item->id ?? '');
    ...
    ';
        ...
        return view('operator.autentikasi.level.index');
    }
    ...
    public function generatepdf()
    {
        ...
        $pdf = PDF::loadview('operator.autentikasi.level.export-pdf', ['level' => $level])->setPaper('A4', 'potrait');
    ...
    {
        return view('operator.autentikasi.level.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('operator-level.index')->with('success', 'Anda berhasil menambahkan Data Status Autentikasi');
    }

    public function edit($id)
    {
        $levels = Level::where('id', $id)->where('is_deleted', '1')->orderBy('id', 'desc')->first();
        return view('operator.autentikasi.level.edit', [
            'levels' => $levels,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('operator-level.index')->with('success', 'Anda berhasil memperbaharui Data Status Autentikasi');
    }
