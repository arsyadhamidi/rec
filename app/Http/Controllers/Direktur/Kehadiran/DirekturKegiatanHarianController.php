...
class DirekturKegiatanHarianController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('direktur.kehadiran.kegiatan-harian.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('direktur.kehadiran.kegiatan-harian.export-pdf', ['kegiatans' => $kegiatans])->setPaper('A4', 'potrait');
