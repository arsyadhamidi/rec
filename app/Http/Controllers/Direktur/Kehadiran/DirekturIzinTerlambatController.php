...
class DirekturIzinTerlambatController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('direktur.kehadiran.izin-terlambat.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('direktur.kehadiran.izin-terlambat.export-pdf', ['izins' => $izins])->setPaper('A4', 'potrait');
