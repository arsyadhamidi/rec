...
class AdminBeritaController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin-berita.index')->with('success', 'Selamat ! Anda berhasil membuat data berita!');
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin-berita.index')->with('success', 'Selamat ! Anda berhasil memperbaharui data berita!');
    }
