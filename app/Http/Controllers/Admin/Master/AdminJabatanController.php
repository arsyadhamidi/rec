...
class AdminJabatanController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $dataWithActions = $data->map(function ($item) {
                $resultid = $item->id ?? '';
                $editUrl = route('admin-jabatan.edit', $item->id ?? '');
    ...
    ';
        ...
        return view('admin.autentikasi.jabatan.index');
    }
    ...
    public function generatepdf()
    {
        ...
        $pdf = PDF::loadview('admin.autentikasi.jabatan.export-pdf', ['jabatan' => $jabatan])->setPaper('A4', 'potrait');
    ...
    {
        return view('admin.autentikasi.jabatan.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin-jabatan.index')->with('success', 'Anda berhasil membuat data jabatan');
    }
    ...
    public function edit($id)
    {
        $jabatan = Jabatan::where('id', $id)
            ...
            ->orderBy('id', 'desc')
            ->first();
        return view('admin.autentikasi.jabatan.edit', [
            'jabatan' => $jabatan,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin-jabatan.index')->with('success', 'Anda berhasil memperbaharui data jabatan');
    }
