...
class AdminIzinTerlambatController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $dataWithActions = $data->map(function ($item) {
                ...
                $editUrl = route("admin-izinterlambat.edit", $item->izin_id ?? '');
    ...
    ';
        ...
        return view('admin.kehadiran.izin-terlambat.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('admin.kehadiran.izin-terlambat.export-pdf', ['izins' => $izins])->setPaper('A4', 'potrait');
    ...
    {
        return view('admin.kehadiran.izin-terlambat.create');
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'user_id.required' => 'Nama karyawan harus dipilih.',
        ...
        return redirect()->route('admin-izinterlambat.index')->with('success', 'Selamat ! Anda berhasil membuat data izin terlambat!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.kehadiran.izin-terlambat.edit', [
            'izins' => $izins,
        ]);
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin-izinterlambat.index')->with('success', 'Selamat ! Anda berhasil memperbaharui data izin terlambat!');
    }
