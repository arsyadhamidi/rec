...
class AdminLemburController extends Controller
{
    public function index(Request $request)
    {
        if ($request->ajax()) {
            ...
            $dataWithActions = $data->map(function ($item) {
                ...
                $editUrl = route("admin-lembur.edit", $item->lembur_id ?? '');
    ...
    ';
        ...
        return view('admin.kehadiran.lembur.index');
    }
    ...
    public function generatepdf(Request $request)
    {
        ...
        $pdf = PDF::loadview('admin.kehadiran.lembur.export-pdf', ['lemburs' => $lemburs])->setPaper('A4', 'potrait');
    ...
    {
        return view('admin.kehadiran.lembur.create');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin-lembur.index')->with('success', 'Anda berhasil menambahkan data lembur');
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.kehadiran.lembur.edit', compact('lemburs'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('admin-lembur.index')->with('success', 'Anda berhasil memperbaharui data lembur');
    }
