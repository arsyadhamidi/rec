...
@section('title', 'Data Jabatan | RSKM Regina Eye Center')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Data Jabatan</li>
                </ol>
            </nav>
        </div>
            ...
            <div class="mb-4">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('operator-jabatan.create') }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/operator-jabatan/destroy/" + resultid, // route('admin-users.destroy', id)
