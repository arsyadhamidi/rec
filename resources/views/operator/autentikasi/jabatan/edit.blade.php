...
@section('title', 'Edit Data Jabatan | RSKM Regina Eye Center')
        ...
        <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('operator-jabatan.index') }}"
                           class="text-primary">Data Jabatan</a></li>
                    <li class="breadcrumb-item active"
                        aria-current="page">Edit Data Jabatan</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('operator-jabatan.update', $jabatan->id ?? '') }}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{route('operator-jabatan.index')}}" class="btn btn-primary">
