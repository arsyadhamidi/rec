...
@section('title', 'Tambah Data User | RSKM Regina Eye Center')
        ...
        <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('operator-users.index') }}"
                           class="text-primary">Data User</a></li>
                    <li class="breadcrumb-item active"
                        aria-current="page">Tambah Data User</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('operator-users.store') }}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <select name="jabatan_id" class="form-control @error('jabatan_id') is-invalid @enderror"
                                            id="selectedJabatan" style="width: 100%">
                                            <option value="" selected>Pilih Jabatan</option>
                                            @foreach ($jabatans as $data)
                                                <option value="{{ $data->id }}"
                                                    {{ $data->id == old('jabatan_id') ? 'selected' : '' }}>
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{route('operator-users.index')}}" class="btn btn-primary">
