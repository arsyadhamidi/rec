            ...
            <div class="mb-4">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('operator-level.create') }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/operator-level/destroy/" + resultid, // route('admin-users.destroy', id)
