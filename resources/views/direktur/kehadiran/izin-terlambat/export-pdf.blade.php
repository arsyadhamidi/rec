...
<body>
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg" style="text-align: center">
                <p><u><b>Data Izin Terlambat</b></u></p>
            </div>
        </div>
        <br>
        <div class="row">
            ...
            <div class="col-lg">
                <table style="width: 100%;border-collapse: collapse; border:1px solid black; margin-top: 30px;">
                    ...
                    1px solid black;">
                        ...
                        <th style="border-right: 1px solid black">Jam.Datang</th>
                    ...
                    @foreach ($izins as $data)
                        <tr style="border: 1px solid black">
                            ...
                            <td style="border-right: 1px solid black; padding: 0xp 7px;">{{ $data->jam_datang ?? '-' }}</td>
