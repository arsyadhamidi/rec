            ...
            <div class="col-lg">
                <table style="width: 100%;border-collapse: collapse; border:1px solid black; margin-top: 30px;">
                    ...
                    1px solid black;">
                        ...
                        <th style="border-right: 1px solid black">Jam.Keluar</th>
                        <th style="border-right: 1px solid black">Jam.Kembali</th>
                        <th style="border-right: 1px solid black">Keperluan</th>
                    ...
                    @foreach ($izins as $data)
                        <tr style="border: 1px solid black">
                            ...
                            <td style="border-right: 1px solid black; padding: 0xp 7px;">{{ $data->jam_keluar ?? '-' }}</td>
                            <td style="border-right: 1px solid black; padding: 0xp 7px;">{{ $data->jam_kembali ?? '-' }}</td>
                            <td style="border-right: 1px solid black; padding: 0xp 7px;">{{ $data->keperluan ?? '-' }}</td>
