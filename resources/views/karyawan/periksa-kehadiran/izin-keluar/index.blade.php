...
@section('title', 'Periksa Data Izin Keluar | RSKM Regina Eye Center')
@section('menuPeriksaKehadiran', 'active')
@section('menuPeriksaDataIzinKeluar', 'active')

@section('content')
    <div class="row">
        <div class="col-lg-6">
            <h3>Periksa Data Izin Keluar</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Periksa Data Izin Keluar</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('karyawan-periksaizinkeluar.index') }}",
                    data: function(data) {
            ...
            $("#myTable").on("click", ".btn-diterima", function() {
                ...
                $.ajax({
                    url: "/karyawan-periksa/izin-keluar/diterima/" + resultid, // route('admin-users.destroy', id)
            ...
            $("#myTable").on("click", ".btn-ditolak", function() {
                ...
                $.ajax({
                    url: "/karyawan-periksa/izin-keluar/ditolak/" + resultid, // route('admin-users.destroy', id)
                    type: "POST", // Laravel destroy biasanya pakai method DELETE
                    data: {
                        _token: "{{ csrf_token() }}", // wajib untuk keamanan Laravel
                    },
