...
@section('title', 'Periksa Data Cuti Tahunan | RSKM Regina Eye Center')
@section('menuPeriksaKehadiran', 'active')
@section('menuDataPeriksaCutiTahunan', 'active')

@section('content')
    <div class="row">
        <div class="col-lg-6">
            <h3>Periksa Data Cuti Tahunan</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Periksa Data Cuti Tahunan</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('karyawan-periksacutitahunan.index') }}",
                    data: function(data) {
            ...
            $("#myTable").on("click", ".btn-diterima", function() {
                ...
                $.ajax({
                    url: "/karyawan-periksa/cuti-tahunan/diterima/" + resultid, // route('admin-users.destroy', id)
            ...
            $("#myTable").on("click", ".btn-ditolak", function() {
                ...
                $.ajax({
                    url: "/karyawan-periksa/cuti-tahunan/ditolak/" + resultid, // route('admin-users.destroy', id)
                    type: "POST", // Laravel destroy biasanya pakai method DELETE
                    data: {
                        _token: "{{ csrf_token() }}", // wajib untuk keamanan Laravel
                    },
