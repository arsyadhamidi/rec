...
@section('title', 'Periksa Data Cuti Menikah | RSKM Regina Eye Center')
@section('menuPeriksaKehadiran', 'active')
@section('menuPeriksaDataCutiMenikah', 'active')

@section('content')
    <div class="row">
        <div class="col-lg-6">
            <h3>Periksa Data Cuti Menikah</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Periksa Data Cuti Menikah</li>
                </ol>
            </nav>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('karyawan-periksacutimenikah.index') }}",
                    data: function(data) {
            ...
            $("#myTable").on("click", ".btn-diterima", function() {
                ...
                $.ajax({
                    url: "/karyawan-periksa/cuti-menikah/diterima/" + resultid, // route('admin-users.destroy', id)
            ...
            $("#myTable").on("click", ".btn-ditolak", function() {
                ...
                $.ajax({
                    url: "/karyawan-periksa/cuti-menikah/ditolak/" + resultid, // route('admin-users.destroy', id)
                    type: "POST", // Laravel destroy biasanya pakai method DELETE
                    data: {
                        _token: "{{ csrf_token() }}", // wajib untuk keamanan Laravel
                    },
