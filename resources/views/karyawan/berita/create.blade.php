...
@section('title', 'Tambah Publikasi / Berita | RSKM Regina Eye Center')
@section('menuBerita', 'active')

@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h3>Tambah Data Publikasi / Berita<h3>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb"
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">Tambah Data Publikasi / Berita
                            <li>
                        </ol>
                    </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('humas-berita.store') }}"
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="judul"
                                              ...
                                              rows="5"
                                              placeholder="Masukan keterangan">{{ old('judul') }}</textarea>
                                    @error('judul')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="ringkasan"
                                              ...
                                              rows="5"
                                              placeholder="Masukan keterangan">{{ old('ringkasan') }}</textarea>
                                    @error('ringkasan')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <textarea name="isi_berita"
                                              ...
                                              id="editorIsiBerita">{{ old('isi_berita') }}</textarea>
                                    @error('isi_berita')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="mb-3 row">
                                ...
                                <div class="col-sm-10">
                                    <select name="status"
                                        ...
                                        <option value="1"
                                                {{ old('status') == '1' ? 'selected' : '' }}>Publish</option>
                                        <option value="0"
                                                {{ old('status') == '0' ? 'selected' : '' }}>Draft</option>
                                    </select>
                                    @error('status')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                ...
                                <div class="col-sm-10">
                                    <select name="kategori_berita_id"
                                        ...
                                        @foreach ($kategoris as $data)
                                            <option value="2"
                                                    {{ old('kategori_berita_id') == $data->id ? 'selected' : '' }}>{{ $data->nm_kategori ?? '-' }}</option>
                                        @endforeach
                                    </select>
