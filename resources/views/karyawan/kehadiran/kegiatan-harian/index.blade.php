...
@section('title', 'Kegiatan Harian | RSKM Regina Eye Center')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Kegiatan Harian</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                <div class="card card-side-left">
                    <div class="card-body">
                        <h4 class="card-title">Pencarian Data Kegiatan Harian</h4>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <input type="text"
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <select name="status"
                                            ...
                                            id="selectedStatus">
                                        <option value=""
                                                selected>== Pilih Status Kegiatan Harian ==</option>
            ...
            <div class="mb-4">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('karyawan-kegiatanharian.create') }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('karyawan-kegiatanharian.index') }}",
                    data: function(data) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            var tglKegiatan = row.tgl_kegiatan ? new Date(row.tgl_kegiatan)
                                .toLocaleDateString() : '-';
            ...
            myTable.on('xhr.dt', function(e, settings, json, xhr) {
               ...
               $('#countTotalKegiatan').text(json.totalKegiatanAlls);
            });
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/karyawan-kegiatan/harian/destroy/" + resultid, // route('admin-users.destroy', id)
