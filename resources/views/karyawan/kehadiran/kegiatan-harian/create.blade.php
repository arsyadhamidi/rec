...
@section('title', 'Tambah Kegiatan Harian | RSKM Regina Eye Center')
        ...
        <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('karyawan-kegiatanharian.index') }}"
                           class="text-primary">Kegiatan Harian</a></li>
                    <li class="breadcrumb-item active"
                        aria-current="page">Tambah Kegiatan Harian</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('karyawan-kegiatanharian.store') }}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('tgl_kegiatan', \Carbon\Carbon::now()->format('Y-m-d')) }}"
                                               id="tglKegiatan">
                                        @error('tgl_kegiatan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
