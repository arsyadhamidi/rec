...
@section('title', 'Edit Data Cuti Menikah | RSKM Regina Eye Center')
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h3>Edit Data Cuti Menikah</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    style="margin-left: -15px">
                    <li class="breadcrumb-item"><a href="/dashboard"
                           class="text-primary">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('karyawan-cutimenikah.index') }}"
                           class="text-primary">Data Cuti Menikah</a></li>
                    <li class="breadcrumb-item active"
                        aria-current="page">Edit Data Cuti Menikah</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('karyawan-cutimenikah.update', $cutis->cuti_id ?? '') }}"
                      method="POST"
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('karyawan-cutimenikah.index') }}"
...
@push('custom-script')
    <script>
        ...
        $pjSelect.select2({
            ...
            ajax: {
                url: "{{ route('karyawan-cutimenikah.getUser') }}",
                dataType: "json",
                delay: 250,
