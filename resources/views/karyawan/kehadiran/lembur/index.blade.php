...
@section('title', 'Data Lembur | RSKM Regina Eye Center')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Data Lembur</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                <div class="card card-side-left">
                    <div class="card-body">
                        <h4 class="card-title">Pencarian Data Lembur</h4>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <input type="text"
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <select name="status"
                                            ...
                                            id="selectedStatus">
                                        <option value=""
                                                selected>== Pilih Status Lembur ==</option>
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('karyawan-lembur.index') }}",
                    data: function(data) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        defaultContent: '-',
                        render: function(data, type, row) {
                            var jamMulai = row.jam_mulai || '-';
                            var jamSelesai = row.jam_selesai || '-';
            ...
            myTable.on('xhr.dt', function(e, settings, json, xhr) {
               ...
               $('#countTotalLembur').text(json.totalLemburAll);
            });
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/karyawan-lembur/destroy/" + resultid, // route('admin-users.destroy', id)
