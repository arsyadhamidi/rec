...
@section('title', 'Data Izin Pulang Cepat | RSKM Regina Eye Center')
...
@section('content')
    <div class="row">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Data Izin Pulang Cepat</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <div class="card card-side-left">
                    <div class="card-body">
                        <h4 class="card-title">Pencarian Data Izin Pulang Cepat</h4>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <input type="text"
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <select name="status"
                                            ...
                                            id="selectedStatus">
                                        <option value=""
                                                selected>== Pilih Status Pulang Cepat ==</option>
            ...
            <div class="mb-3">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('karyawan-pulangcepat.create') }}"
        ...
        <div class="col-lg-12 mb-4">
            <h5>Status Izin Pulang Cepat</h5>
            <div class="row"
                 id="statusSummary">
                <!-- Batal -->
                ...
                <div class="col-md-2 col-sm-4 col-6 mb-3">
                    <div class="card text-white bg-secondary shadow-sm">
                        <div class="card-body p-2 text-center">
                            <h6 class="card-title mb-1">Total Pulang Cepat</h6>
                            <span id="countTotalPulang"
                                  class="h5 fw-bold">0</span>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('karyawan-pulangcepat.index') }}",
                    data: function(data) {
                ...
                columns: [{
                    ...
                    },
                    {
                        ...
                        render: function(data, type, row) {
                            var tglIzin = row.tgl_izin ? new Date(row.tgl_izin)
                                .toLocaleDateString() : '-';
            ...
            myTable.on('xhr.dt', function(e, settings, json, xhr) {
               ...
               $('#countTotalPulang').text(json.totalPulangs);
            });
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/karyawan-pulang/cepat/destroy/" + resultid, // route('admin-users.destroy', id)
