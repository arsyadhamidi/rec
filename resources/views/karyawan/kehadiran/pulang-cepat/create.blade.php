...
@section('title', 'Tambah Data Pulang Cepat | RSKM Regina Eye Center')
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h3>Tambah Data Pulang Cepat</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('karyawan-pulangcepat.index') }}"
                           class="text-primary">Data Pulang Cepat</a></li>
                    <li class="breadcrumb-item active"
                        aria-current="page">Tambah Data Pulang Cepat</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('karyawan-pulangcepat.store') }}"
                      method="POST"
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('jam_pulang', \Carbon\Carbon::now()->format('H:i:s')) }}"
                                               id="jamPulang">
                                        @error('jam_pulang')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alasan"
                                                  ...
                                                  rows="5"
                                                  placeholder="Masukan alasan pulang cepat">{{ old('alasan') }}</textarea>
                                        @error('alasan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
