...
@section('title', 'Data Sakit | RSKM Regina Eye Center')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Data Sakit</li>
                </ol>
            </nav>
        </div>
    </div>
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                <div class="card card-side-left">
                    <div class="card-body">
                        <h4 class="card-title">Pencarian Data Sakit</h4>
                        <div class="row">
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <input type="text"
                            ...
                            <div class="col-lg-3">
                                <div class="mb-3">
                                    <select name="status"
                                            ...
                                            id="selectedStatus">
                                        <option value=""
                                                selected>== Pilih Status Sakit ==</option>
            ...
            <div class="mb-4">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('karyawan-sakit.create') }}"
            ...
            <div class="row"
                ...
                <div class="col-md-2 col-sm-4 col-6 mb-3">
                    <div class="card text-white bg-secondary shadow-sm">
                        <div class="card-body p-2 text-center">
                            <h6 class="card-title mb-1">Total Sakit</h6>
                            <span id="countTotalSakit"
                                  class="h5 fw-bold">0</span>
                        </div>
                    </div>
                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('karyawan-sakit.index') }}",
                    data: function(data) {
            ...
            myTable.on('xhr.dt', function(e, settings, json, xhr) {
               ...
               $('#countTotalSakit').text(json.totalSakits);
            });
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/karyawan-sakit/destroy/" + resultid, // route('admin-users.destroy', id)
