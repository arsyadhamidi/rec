...
@section('title', 'Tambah Data Sakit | RSKM Regina Eye Center')
...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            <h3>Tambah Data Sakit</h3>
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    style="margin-left: -15px">
                    <li class="breadcrumb-item"><a href="/dashboard"
                           class="text-primary">Dashboard</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('karyawan-sakit.index') }}"
                           class="text-primary">Data Sakit</a></li>
                    <li class="breadcrumb-item active"
                        aria-current="page">Tambah Data Sakit</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('karyawan-sakit.store') }}"
                      method="POST"
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('karyawan-sakit.index') }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#selectedAtasan').select2({
                ...
                ajax: {
                    url: '{{ route('karyawan-sakit.getUser') }}',
                    dataType: 'json',
                    delay: 250,
