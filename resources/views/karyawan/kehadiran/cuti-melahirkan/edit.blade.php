...
@section('content')
    <div class="row">
        <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('karyawan-cutimelahirkan.index') }}"
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('karyawan-cutimelahirkan.update', $cutis->cuti_id ?? '') }}"
                      method="POST"
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('karyawan-cutimelahirkan.index') }}"
...
@push('custom-script')
    <script>
        ...
        $atasanSelect.select2({
            ...
            ajax: {
                url: "{{ route('karyawan-cutimelahirkan.getUser') }}",
                dataType: "json",
                delay: 250,
