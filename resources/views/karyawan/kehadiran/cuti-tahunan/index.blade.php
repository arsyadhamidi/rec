            ...
            <div class="mb-3">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('karyawan-cutitahunan.create') }}"
            ...
            <div class="row"
                ...
                <div class="col-md-2 col-sm-4 col-6 mb-3">
                    <div class="card text-white bg-secondary shadow-sm">
                        <div class="card-body p-2 text-center">
                            <h6 class="card-title mb-1">Total Cuti</h6>
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('karyawan-cutitahunan.index') }}",
                    data: function(data) {
            ...
            myTable.on('xhr.dt', function(e, settings, json, xhr) {
               ...
               $('#countTotalCuti').text(json.totalCutiTahunans);
            });
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/karyawan-cuti/tahunan/destroy/" + resultid, // route('admin-users.destroy', id)
