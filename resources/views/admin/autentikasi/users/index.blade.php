                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        $('#generatepdf').attr('href',
                            `{{ route('admin-users.generatepdf') }}?level_id=${data.level_id}&jabatan_id=${data.jabatan_id}`
                        );

                        $('#generateexcel').attr('href',
                            `{{ route('admin-users.generateexcel') }}?level_id=${data.level_id}&jabatan_id=${data.jabatan_id}`
                        );
                    },
                },
                columns: [{
