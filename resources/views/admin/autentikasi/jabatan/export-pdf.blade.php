            ...
            <div class="col-lg">
                <table style="width: 100%;border-collapse: collapse; border:1px solid black; margin-top: 30px;">
                    ...
                    1px solid black;">
                        ...
                        <th style="border-right: 1px solid black">Kode Jabatan</th>
                        <th style="border-right: 1px solid black">Nama Jabatan</th>
                    </tr>
                    @foreach ($jabatan as $data)
                        <tr style="border: 1px solid black">
                            <td style="border-right: 1px solid black; text-align:center; padding: 10px 0px">
                                {{ $loop->iteration }}</td>
                            <td style="border-right: 1px solid black; padding: 0xp 7px;">{{ $data->kd_jabatan ?? '-' }}</td>
