...
@section('title', 'Edit Data Kategori Berita | RSKM Regina Eye Center')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Edit Data Kategori Berita</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('admin-kategoriberita.update', $kategoris->id ?? '') }}"
                      method="POST">
                    @csrf
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('nm_kategori', $kategoris->nm_kategori ?? '-') }}"
