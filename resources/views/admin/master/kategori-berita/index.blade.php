...
@section('title', 'Data Kategori Berita | RSKM Regina Eye Center')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Data Kategori Berita</li>
                </ol>
            </nav>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/admin-kategori/berita/destroy/" + resultid, // route('admin-users.destroy', id)
