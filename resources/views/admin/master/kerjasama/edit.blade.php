...
@section('title', 'Edit Asuransi Kesehatan | RSKM Regina Eye Center')
...
@section('content')
    <div class="row">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Edit Asuransi Kesehatan</li>
                </ol>
            </nav>
        </div>
        ...
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('admin-kerjasama.update', $kerjas->id ?? '') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('nm_kerjasama', $kerjas->nm_kerjasama ?? '-') }}"
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="keterangan"
                                                  ...
                                                  id="keteranganTextEdit"
                                                  placeholder="Masukan keterangan">{{ old('keterangan', $kerjas->keterangan ?? '-') }}</textarea>
                                        @error('keterangan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="syarat"
                                                  ...
                                                  id="syaratTextEdit"
                                                  placeholder="Masukan syarat">{{ old('syarat', $kerjas->syarat ?? '-') }}</textarea>
                                        @error('syarat')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
...
@push('custom-script')
    <script>
        CKEDITOR.replace('keteranganTextEdit');
        CKEDITOR.replace('syaratTextEdit');
    </script>
@endpush
