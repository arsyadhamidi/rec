...
@section('title', 'Asuransi Kesehatan | RSKM Regina Eye Center')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Asuransi Kesehatan</li>
                </ol>
            </nav>
        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/admin-kerjasama/destroy/" + resultid, // route('admin-users.destroy', id)
