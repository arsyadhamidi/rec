...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td class="d-flex">
                                                ...
                                                <div class="modal fade"
                                                     ...
                                                     aria-hidden="true">
                                                    <form action="{{ route('admin-dokter.updatecutidokter', $cuti->id ?? '') }}"
                                                          method="POST">
                                                        @csrf
                                                ...
                                                <form action="{{ route('admin-dokter.destroycutidokter', $cuti->id ?? '') }}"
                                                      method="POST">
                                                    @csrf
                                                    <button type="submit"
    ...
    <div class="modal fade"
         ...
         aria-labelledby="exampleModalLabel"
         aria-hidden="true">
        <form action="{{ route('admin-dokter.storecutidokter') }}"
              method="POST">
            @csrf
            <input type="hidden"
                   class="form-control"
