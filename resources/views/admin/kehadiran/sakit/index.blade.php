            ...
            <div class="mb-4">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('admin-sakit.create') }}"
    ...
    <script>
        $(document).ready(function() {
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        $('#generatepdf').attr('href',
                            `{{ route('admin-sakit.generatepdf') }}?status=${status}&start_date=${startDate}&end_date=${endDate}`
                        );

                        $('#generateexcel').attr('href',
                            `{{ route('admin-sakit.generateexcel') }}?status=${status}&start_date=${startDate}&end_date=${endDate}`
                        );
                    },
                },
                columns: [{
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/admin-sakit/destroy/" + resultid, // route('admin-users.destroy', id)
