            ...
            <div class="mb-3">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('admin-pulangcepat.create') }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('admin-pulangcepat.index') }}",
                    data: function(data) {
                        ...
                        $('#generatepdf').attr('href',
                            `{{ route('admin-pulangcepat.generatepdf') }}?status=${status}&start_date=${startDate}&end_date=${endDate}`
                        );

                        $('#generateexcel').attr('href',
                            `{{ route('admin-pulangcepat.generateexcel') }}?status=${status}&start_date=${startDate}&end_date=${endDate}`
                        );
                    },
                },
                columns: [{
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/admin-pulang/cepat/destroy/" + resultid, // route('admin-users.destroy', id)
