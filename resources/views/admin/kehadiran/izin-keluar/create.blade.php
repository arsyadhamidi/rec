...
@section('title', 'Tambah Data Izin Keluar | RSKM Regina Eye Center')
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item active"
                        aria-current="page">Tambah Data Izin Keluar</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('admin-izinkeluar.store') }}"
                                ...
                                <div class="col-lg-6">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('tgl_izin', \Carbon\Carbon::now()->format('Y-m-d')) }}"
                                               id="tglIzin">
                                        @error('tgl_izin')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('jam_keluar', \Carbon\Carbon::now()->format('H:i:s')) }}"
                                               id="jamKeluar">
                                        @error('jam_keluar')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="col-lg-3">
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                               ...
                                               value="{{ old('jam_kembali', \Carbon\Carbon::now()->format('H:i:s')) }}"
                                               id="jamKembali">
                                        @error('jam_kembali')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                ...
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <textarea name="keperluan"
                                                  ...
                                                  rows="5"
                                                  placeholder="Masukan keperluan keluar">{{ old('keperluan') }}</textarea>
                                        @error('keperluan')
                                            <div class="invalid-feedback">
                                                {{ $message }}
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#selectedAtasan').select2({
                ...
                ajax: {
                    url: '{{ route('admin-izinkeluar.getUser') }}',
                    dataType: 'json',
                    delay: 250,
