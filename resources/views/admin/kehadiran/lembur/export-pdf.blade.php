            ...
            <div class="col-lg">
                <table style="width: 100%;border-collapse: collapse; border:1px solid black; margin-top: 30px;">
                    ...
                    1px solid black;">
                        ...
                        <th style="border-right: 1px solid black">Jam.Mulai</th>
                    ...
                    @foreach ($lemburs as $data)
                        <tr style="border: 1px solid black">
                            ...
                            <td style="border-right: 1px solid black; padding: 0xp 7px;">{{ $data->jam_mulai ?? '-' }}</td>
                            <td style="border-right: 1px solid black; padding: 0xp 7px;">{{ $data->jam_selesai ?? '-' }}</td>
                            <td style="border-right: 1px solid black; padding: 0xp 7px;">{{ $data->total ?? '-' }}</td>
