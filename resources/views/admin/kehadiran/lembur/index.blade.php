    ...
    <script>
        $(document).ready(function() {
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        $('#generatepdf').attr('href',
                            `{{ route('admin-lembur.generatepdf') }}?status=${status}&start_date=${startDate}&end_date=${endDate}`
                        );

                        $('#generateexcel').attr('href',
                            `{{ route('admin-lembur.generateexcel') }}?status=${status}&start_date=${startDate}&end_date=${endDate}`
                        );
                    },
                },
                columns: [{
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/admin-lembur/destroy/" + resultid, // route('admin-users.destroy', id)
