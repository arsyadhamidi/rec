...
@section('title', 'Edit Data Potong Gaji | RSKM Regina Eye Center')
        ...
        <div class="col-lg-12">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb"
                    ...
                    <li class="breadcrumb-item"><a href="/dashboard"
                           class="text-primary">Data Potong Gaji</a></li>
                    <li class="breadcrumb-item active"
                        aria-current="page">Edit Data Potong Gaji</li>
                </ol>
            </nav>
        </div>
        <div class="col-lg-12">
            <div class="mb-3">
                <form action="{{ route('admin-potonggaji.update', $cutis->cuti_id ?? '') }}"
                      method="POST"
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            ...
                            <a href="{{ route('admin-potonggaji.index') }}"
...
@push('custom-script')
    <script>
        ...
        $pjSelect.select2({
            ...
            ajax: {
                url: "{{ route('admin-potonggaji.getUser') }}",
                dataType: "json",
                delay: 250,
