            ...
            <div class="mb-4">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ route('admin-cutimelahirkan.create') }}"
    ...
    <script>
        $(document).ready(function() {
            ...
            let myTable = $("#myTable").DataTable({
                ...
                ajax: {
                    url: "{{ route('admin-cutimelahirkan.index') }}",
                    data: function(data) {
                        ...
                        $('#generatepdf').attr('href',
                            `{{ route('admin-cutimelahirkan.generatepdf') }}?status=${status}&start_date=${startDate}&end_date=${endDate}`
                        );

                        $('#generateexcel').attr('href',
                            `{{ route('admin-cutimelahirkan.generateexcel') }}?status=${status}&start_date=${startDate}&end_date=${endDate}`
                        );
                    },
                },
                columns: [{
            ...
            $("#myTable").on("click", ".btn-delete", function() {
                ...
                $.ajax({
                    url: "/admin-cuti/melahirkan/destroy/" + resultid, // route('admin-users.destroy', id)
